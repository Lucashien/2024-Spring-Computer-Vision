...
python3 p2_inference.py --test_datadir /mnt/r12921a10/DS920/CV/dataset/hw2_data/p2_data/unlabel --model_type resnet18 --output_path ./output/pred.csv
...
python3 p2_eval.py --csv_path ./output/pred.csv --annos_path /mnt/r12921a10/DS920/CV/dataset/hw2_data/p2_data/unlabel/annotations.json
